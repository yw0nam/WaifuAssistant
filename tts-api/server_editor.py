...
parser.add_argument("--line_length", type=int, default=50)
parser.add_argument("--line_count", type=int, default=5)
parser.add_argument("--skip_default_models", action="store_true", default=True)
parser.add_argument("--skip_static_files", action="store_true", default=True)
